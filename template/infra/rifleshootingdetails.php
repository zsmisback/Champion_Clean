...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control" name="rifleshootingform_info|field_length" id="colength" placeholder="The Field length (in meters)" <?php if($_GET['page'] == 'editinfra'){echo "value='".$response['field_length']."'";}?>>
</div>
<div class="col-md-6">
<input type="text" class="form-control" name="rifleshootingform_info|field_width" id="cowidth" placeholder="The Field width (in meters)" <?php if($_GET['page'] == 'editinfra'){echo "value='".$response['field_width']."'";}?>>
</div>
</div>
<br>

<div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='rifleshootingform_info|seats' value='seats' <?php if($_GET['page'] == 'editinfra'){if(!empty($response['seats'])){echo 'checked';}}?>>Do you provide seats?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='rifleshootingform_info|locker_room' value='locker_room' <?php if($_GET['page'] == 'editinfra'){if(!empty($response['locker_room'])){echo 'checked';}}?>>Do you provide locker rooms?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='rifleshootingform_info|showers' value='showers' <?php if($_GET['page'] == 'editinfra'){if(!empty($response['showers'])){echo 'checked';}}?>>Do you provide showers?
			 </div>
<br>
<textarea class="form-control mb-4" rows="5" name="rifleshootingform_info|summary" id="basketsummary" placeholder="Add a summary about your rifle field"><?php if($_GET['page'] == 'editinfra'){echo $response['summary'];}?></textarea>
...
<textarea class="form-control mb-4 ckeditor" rows="5" name="rifleshootingform_info|features" id="cricfeatures"><?php if($_GET['page'] == 'editinfra'){echo $response['features'];}?></textarea>
<br>
<p class="mb-3">Rules(If any):</p>	
<textarea class="form-control mb-4 ckeditor" rows="5" name="rifleshootingform_info|rules" id="cricrules"><?php if($_GET['page'] == 'editinfra'){echo $response['rules'];}?></textarea>
</fieldset>
