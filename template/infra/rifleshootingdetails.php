...
<input type="hidden" class="form-control" id="" name="infra_sports|sport" value="rifleshooting" />
<?php
...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="infra_sports|name_sports" id="cricground" placeholder="Rifle Shooting ground/turf name" <?php if($_GET['page'] == 'editinfra'){echo "value='".$response['name_sports']."'";}?>>
</div>
<div class="col-md-6">
...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control" name="infra_sports|custom_1" id="colength" placeholder="The Field length (in meters)" <?php if($_GET['page'] == 'editinfra'){echo "value='".$response['custom_1']."'";}?>>
</div>
<div class="col-md-6">
<input type="text" class="form-control" name="infra_sports|custom_2" id="cowidth" placeholder="The Field width (in meters)" <?php if($_GET['page'] == 'editinfra'){echo "value='".$response['custom_2']."'";}?>>
</div>
</div>
<br>
...
<br>
<textarea class="form-control mb-4" rows="5" name="infra_sports|summary" id="basketsummary" placeholder="Add a summary about your rifle field"><?php if($_GET['page'] == 'editinfra'){echo $response['summary'];}?></textarea>
