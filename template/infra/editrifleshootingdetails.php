...
<input type="hidden" class="form-control" id="" name="rifleshootingform_info|ground_uid" value="<?php echo $response['ground_uid']; ?>"/>

<h2>Edit Rifle Shooting registration</h2>
<hr>
<h5 class="">The Field</h5>
<fieldset class="border border-gary p-4 mb-5">
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control" name="rifleshootingform_info|field_length" id="colength" placeholder="The Field length (in meters)" value="<?php echo $response['field_length']; ?>">
</div>
<div class="col-md-6">
<input type="text" class="form-control" name="rifleshootingform_info|field_width" id="cowidth" placeholder="The Field width (in meters)" value="<?php echo $response['field_width']; ?>">
</div>
</div>
<br>

<div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='rifleshootingform_info|seats' value='seats' <?php if(!empty($response['seats'])){echo 'checked';} ?>>Do you provide seats?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='rifleshootingform_info|locker_room' value='locker_room' <?php if(!empty($response['locker_room'])){echo 'checked';} ?>>Do you provide locker rooms?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='rifleshootingform_info|showers' value='showers' <?php if(!empty($response['showers'])){echo 'checked';} ?>>Do you provide showers?
			 </div>
<br>
<textarea class="form-control mb-4" rows="5" name="rifleshootingform_info|summary" id="basketsummary" placeholder="Add a summary about your rifle field"><?php echo $response['summary']; ?></textarea>
...
<textarea class="form-control mb-4 ckeditor" rows="5" name="rifleshootingform_info|features" id="cricfeatures"><?php echo $response['features']; ?></textarea>
<br>
<p class="mb-3">Rules(If any):</p>	
<textarea class="form-control mb-4 ckeditor" rows="5" name="rifleshootingform_info|rules" id="cricrules"><?php echo $response['rules']; ?></textarea>
</fieldset>
