...
<input type="hidden" class="form-control" id="" name="cricketform_info|ground_uid" value="<?php echo $response['ground_uid']; ?>"/>

<h2>Edit Cricket registration</h2>
<hr>
...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="cricketform_info|cricket_ground_size" id="cricground" value = "<?php echo $response['cricket_ground_size']; ?>" placeholder="Cricket ground size (in meters)">
</div>
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="cricketform_info|cricket_pitch_size" id="cricpitch" value = "<?php echo $response['cricket_pitch_size']; ?>" placeholder="Cricket pitch size (in meters)">
</div>
</div>
<br>
<div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='cricketform_info|seats' value='seats' <?php if(!empty($response['seats'])){echo 'checked';} ?>>Do you have sitting arrangements?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='cricketform_info|locker_room' value='locker_room' <?php if(!empty($response['locker_room'])){echo 'checked';} ?>>Do you provide locker rooms?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='cricketform_info|showers' value='showers' <?php if(!empty($response['showers'])){echo 'checked';} ?>>Do you provide shower rooms?
			 </div>
<br>
<textarea class="form-control mb-4" rows="5" name="cricketform_info|summary" id="cricsummary" placeholder="Add a summary about your cricket field"><?php echo $response['summary']; ?></textarea>
</fieldset>
<fieldset class="border border-gary p-4 mb-5">
...
<textarea class="form-control mb-4 ckeditor" rows="5" name="cricketform_info|features" id="cricfeatures"><?php echo $response['features']; ?></textarea>
<br>
<p class="mb-3">Rules(If any):</p>	
<textarea class="form-control mb-4 ckeditor" rows="5" name="cricketform_info|rules" id="cricrules"><?php echo $response['rules']; ?></textarea>
</fieldset>
