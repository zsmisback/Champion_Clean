...
<input type="hidden" class="form-control" id="" name="footballform_info|ground_uid" value="<?php echo $response['ground_uid']; ?>"/>

<h2>Edit Football registration</h2>
<hr>
...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="footballform_info|field_length" id="footfieldlength" placeholder="Football field length size (in meters)" value="<?php echo $response['field_length']; ?>">
</div>
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="footballform_info|field_width" id="footfieldwidth" placeholder="Football field width size (in meters)" value="<?php echo $response['field_width']; ?>">
</div>
</div>
...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="footballform_info|goal_length" id="golength" placeholder="The goal area length size (in meters)" value="<?php echo $response['goal_length']; ?>">
</div>
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="footballform_info|goal_width" id="gowidth" placeholder="The goal area width size (in meters)" value="<?php echo $response['goal_width']; ?>">
</div>
</div>
...
<div class="row">
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="footballform_info|penalty_length" id="penlength" placeholder="The penalty area length size (in meters)" value="<?php echo $response['penalty_length']; ?>">
</div>
<div class="col-md-6">
<input type="text" class="form-control mb-4" name="footballform_info|penalty_width" id="penwidth" placeholder="The penalty area width size (in meters)" value="<?php echo $response['penalty_width']; ?>">
</div>
</div>
<br>
<div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='footballform_info|seats' value='seats' <?php if(!empty($response['seats'])){echo 'checked';} ?>>Do you provide seats?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='footballform_info|locker_room' value='locker_room' <?php if(!empty($response['locker_room'])){echo 'checked';} ?>>Do you provide locker rooms?
			 </div><div class='form-check'>
		     <input type='checkbox' class='form-check-input mb-4' name='footballform_info|showers' value='showers' <?php if(!empty($response['showers'])){echo 'checked';} ?>>Do you provide showers?
			 </div>
<br>
<textarea class="form-control mb-4" rows="5" name="footballform_info|summary" id="footsummary" placeholder="Add a summary about your football field"><?php echo $response['summary']; ?></textarea>
...
<textarea class="form-control mb-4 ckeditor" rows="5" name="footballform_info|features" id="cricfeatures"><?php echo $response['features']; ?></textarea>
<br>
<p class="mb-3">Rules(If any):</p>	
<textarea class="form-control mb-4 ckeditor" rows="5" name="footballform_info|rules" id="cricrules"><?php echo $response['rules']; ?></textarea>
</fieldset>
