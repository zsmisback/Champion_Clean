...
?>
		...
		echo'<div class="row p-lg-3 p-sm-5 p-4">
			 ...
			 <a href="index.php?page=eventdetails&id='.$event['event_id'].'"><img src="'.$event['image'].'" class="img-fluid" alt="" style="width:100%;height:210px;"></a>
				...
				<div class="col-lg-8">
					<div class="row">
						<div class="col-lg-9 col-md-10">
							<div class="ad-listing-content">
								<div>
								<a href="index.php?page=eventdetails&id='.$event['event_id'].'"><h2 class="font-weight-bold">'.$event['name'].'</h2></a>
									<p class="font-weight-bold">Held at '.$event['address'].'</p>
								</div>
								<ul class="list-inline mt-2 mb-3">';
								 $sports = explode(",",$event['sports']);
						...
						/*<div class="col-lg-3 align-self-center">
							...
							<a href="index.php?page=eventdetails&id='.$event['event_id'].'"><button class="btn-success">Know More</button></a>
						</div>						
						</div>
					</div>*/
				echo'</div>
