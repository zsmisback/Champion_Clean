                    ...
                    <div class="border border">
                        ...
                        <form action="" method="post">	
							...
							<?php if(isset($error_mysql)){echo $error_mysql;}  ?>
								...
								<div class="col-md-6">
                                <a href="trainer.php?page=editprofile"><button type="button" class="d-block py-3 px-4 bg-primary text-white border-0 rounded font-weight-bold">Go Back</button></a>
								</div>
								</div>
                            </fieldset>
                        </form>
